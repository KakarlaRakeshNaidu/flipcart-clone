...
const Confirmation = () => {
  ...
  return (
    <div className="bg-[#F1F3F6] min-h-screen py-4 md:py-8 flex items-center justify-center px-3 md:px-0">
      <div className="bg-white shadow-sm p-6 md:p-10 max-w-[500px] w-full text-center flex flex-col items-center gap-3 md:gap-4 rounded-sm">
        <div className="bg-[#388E3C] text-white w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-md mb-2 md:mb-4 animate-bounce">
          <Check size={40} strokeWidth={3} />
        </div>
        <h1 className="text-[20px] md:text-[24px] font-bold text-[#212121]">Order Placed Successfully!</h1>
        <p className="text-[14px] md:text-[16px] text-[#878787]">
